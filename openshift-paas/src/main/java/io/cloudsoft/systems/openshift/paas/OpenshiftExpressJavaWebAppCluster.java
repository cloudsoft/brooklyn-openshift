package io.cloudsoft.systems.openshift.paas;

import io.cloudsoft.systems.openshift.paas.OpenshiftExpressAccess.AppInfoFields;
import io.cloudsoft.systems.openshift.paas.OpenshiftExpressAccess.UserInfoFields;
import io.cloudsoft.systems.openshift.paas.OpenshiftExpressAccess.UserInfoResult;
...
git rm -rf *
mkdir deployments
cp /Users/alex/data/cloudsoft/projects/monterey/gits/io/cloudsoft/systems/openshift/paas/target/test-classes/hello-world.war deployments/ROOT.war
touch deployments/ROOT.war.dodeploy
git add deployments
git commit -m "brooklyn automated project restructure for deployment of WAR file"
git push
